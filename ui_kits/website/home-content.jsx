...
const WC = {
  de: {
    ...
    footer: {
      ...
      visit: 'Besuchen Sie uns', address: ['Weingut Wasem Doppelstück', 'Burkhard Wasem', 'Stiegelgasse 50', '55218 Ingelheim'],
  ...
  en: {
    ...
    footer: {
      ...
      visit: 'Visit us', address: ['Weingut Wasem Doppelstück', 'Burkhard Wasem', 'Stiegelgasse 50', '55218 Ingelheim'],
